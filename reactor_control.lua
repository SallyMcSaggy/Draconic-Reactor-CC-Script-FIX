...
function update()
  while true do 
    ...
    f.draw_text_lr(mon, 2, 4, 1, "Generation", f.format_int(ri.generationRate) .. " FE/t", colors.white, colors.lime, colors.black)
    ...
    f.draw_text_lr(mon, 2, 7, 1, "Output Gate", f.format_int(fluxgate.getSignalLowFlow()) .. " FE/t", colors.white, colors.blue, colors.black)

    -- buttons
    drawButtons(8)

    f.draw_text_lr(mon, 2, 9, 1, "Input Gate", f.format_int(inputfluxgate.getSignalLowFlow()) .. " FE/t", colors.white, colors.blue, colors.black)
